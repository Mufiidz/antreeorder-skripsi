...
class _DetailAntreeScreenState extends State<DetailAntreeScreen> {
  ...
  void initState() {
    ...
    _detailAntreeMerchantBloc
        .add(DetailAntreeMerchantEvent.initial(widget.antree));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<DetailAntreeMerchantBloc, DetailAntreeMerchantState>(
        ...
        builder: (context, state) {
          ...
          return Column(
            children: [
              Expanded(
                  flex: 2,
                  child: AntreeList<Widget>(_section(state.antree),
                      isSeparated: true,
                          ...
                          children: [
                            Expanded(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  ...
                                  if (negativeBtn ==
                                    ...
                                    _detailAntreeMerchantBloc.add(
                                        DetailAntreeMerchantEvent.cancelAntree(
                                            state.antree));
                                  }
                                  if (negativeBtn ==
                                ...
                                child:
                                    Text(detailAntreeButton.negativeButtonText),
  ...
  List<Widget> _section(Antree antree) => [
